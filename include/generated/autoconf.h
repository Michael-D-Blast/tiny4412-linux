...
#define CONFIG_TINY4412_BUTTONS 1
...
#define CONFIG_CMDLINE "root=/dev/mmcblk0p2 rootfstype=ext4 init=/linuxrc console=ttySAC0,115200 lcd=HD700 ctp=2 skipcali=y"
